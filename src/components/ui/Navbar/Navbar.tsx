        ...
        <>
            <div className="flex items-center justify-between p-4">
                ...
                <div className="flex items-center gap-6 justify-end w-full">
                    <div className="w-7 h-7 bg-white flex items-center justify-center cursor-pointer rounded-full">
                      <Image src="/message.png" alt="search" width={20} height={20}/>
                    </div>
                    <div className="w-7 h-7 bg-white flex items-center justify-center cursor-pointer rounded-full relative">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xs leading-3 font-medium">Osman Goni</span>
